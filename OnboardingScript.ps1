...
try {
    ...
    $env:SUBSCRIPTION_ID = "512817a3-87c7-4af5-a7ea-829b55885255";
    $env:RESOURCE_GROUP = "rg-sentinel-lab";
    $env:TENANT_ID = "f4c3cb00-44f5-44d2-af46-7ed0e38cc5c7";
    $env:LOCATION = "francecentral";
    $env:AUTH_TYPE = "token";
    $env:CORRELATION_ID = "b99ee354-2e87-4abb-bfb7-e73d3179f794";
